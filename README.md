...
```
 ...
 - Finally, in `yolact_edge_config` in the same file, change the value for `'dataset'` to `'my_custom_dataset'` or whatever you named the config object above and change `'num_classes'` to number of classes in your dataset+1. Then you can use any of the training commands in the previous section.
