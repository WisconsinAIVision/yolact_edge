...
weights = "$(WEIGHTS_DIR)/yolact_edge_youtubevis_resnet50_847_50000.pth"
...
calib_images = "$(REPO_DIR)/yolact_edge/data/YoutubeVIS/calib_images/:prev:next"
...
img = cv2.imread("$(AWESOME_PICTURE).jpg")
